...
switchValueButton.addEventListener("click", () => {
  // const originallyFirstInput = firstSwitchValueInput.value;
  // firstSwitchValueInput.value = secondSwitchValueInput.value;
  // secondSwitchValueInput.value = originallyFirstInput;
  let firstInputValue = firstSwitchValueInput.value;
  let secondInputValue = secondSwitchValueInput.value;

  firstSwitchValueInput.value = secondInputValue;
